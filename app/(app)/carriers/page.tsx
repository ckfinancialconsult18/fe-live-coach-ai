    ...
    <div className="space-y-6 max-w-[1600px]">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="glass-card rounded-2xl p-4">
          ...
          <p className="text-2xl font-bold text-slate-200">{mockCarriers.length}</p>
        </div>
        <div className="glass-card rounded-2xl p-4">
          <p className="text-xs text-slate-500 mb-1">Active Contracts</p>
          <p className="text-2xl font-bold text-blue-400">{mockCarriers.reduce((s, c) => s + c.activeContracts, 0)}</p>
        </div>
        <div className="glass-card rounded-2xl p-4">
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-white/6">
                  <div className="text-center">
                    <p className="text-xl font-bold text-slate-200">{carrier.activeContracts}</p>
